...
def main():
    parser = argparse.ArgumentParser(description="Extract relative lidar odometry from ROS2 bag (mcap or db3).")
    ...
    parser.add_argument("--topic", default="/dliom/odom_node/odom", help="Odometry topic name")
    parser.add_argument("--output", default="lidar_odom.csv", help="Output CSV file path")
